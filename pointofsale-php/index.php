...
} elseif (isset($_GET['logout']) && $_GET['logout'] == 'sukses') {
  $toastMessage = 'Anda Telah Berhasil Logout.';
  $toastIcon = 'success';
} elseif (isset($_GET['access']) && $_GET['access'] == 'denied') {
  $toastMessage = 'Akses Ditolak! Silakan Login Terlebih Dahulu.';
  $toastIcon = 'warning';
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Login | Point of Sales 2025</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="#" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">Point of Sales 2025</span>
                </a>
              </div>
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form class="row g-3" method="POST" action="conf/autentikasi.php" novalidate>
                    <div class="col-12">
